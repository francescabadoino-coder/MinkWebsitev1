 ...
 *
 * Anchor map:
 *   1 -> Slate/Pro/Studio prices (cards + comparison table price row)
 *   2 -> "100 / 500 / 1,000 2D visualizations / month" + the 15-viz trial
...
export const PRICING_FOOTNOTES: string[] = [
  "Paid plans (Slate, Pro, and Studio) renew automatically at the price shown until you cancel. Cancel any time from account settings; cancellation takes effect at the end of your current billing period. We do not offer partial refunds for time remaining in a billing cycle. Prices may change, and current subscribers are notified before any change affects their plan. Prices shown may exclude applicable taxes, which are calculated at checkout.",
  "Monthly visualization limits (100 on Slate, 500 on Pro, 1,000 on Studio) reset at the start of each billing cycle and do not roll over. The free Trial includes 15 visualizations to start; a paid plan is required to generate more. You can upgrade any time for a higher limit.",
...
export const FEATURE_FOOTNOTES: Record<string, number> = {
  "100 2D visualizations / month": 2,
  "500 2D visualizations / month": 2,
  "1,000 2D visualizations / month": 2,
  "15 2D visualizations to start": 2,
